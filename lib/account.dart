      ...
      body: Container(
        ...
        child: ListView(
          children: [
            Text(
              "Your Profile",
              style: TextStyle(fontWeight: FontWeight.w600,fontSize: 30,color:Colors.white),
            ),
            Stack(
              children: [
                Container(
