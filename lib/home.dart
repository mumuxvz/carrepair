...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double min=double.parse((dist).toStringAsFixed(2));
    List garagename=[
      'Vrundavan',
      'Jignesh',
      'patel',
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                child: Text('Just press the button',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w200,fontFamily: 'Poppins',fontSize: 15 ),),
              ),
              SizedBox(
                height: 20,
              ),
              Container(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () {
                    ...
                    garage=caldist();
                    print(garage);
                    sending_SMS("https://www.google.com/maps/search/?api=1&query=${yourlocation.latitude},${yourlocation.longitude} mobile no = 9924800702",['9265275682']);
