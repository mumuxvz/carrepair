import 'package:myfinalcar/signup.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:myfinalcar/homescreen.dart';
import 'package:myfinalcar/signup.dart';
          ...
          child: Container(
            ...
            child: Row(
                ...
                children: <Widget>[
                  ...
                  // SizedBox(width: 5.0,),
                  Text("Google",style:TextStyle(fontFamily: 'Poppins',fontSize: 15,fontWeight: FontWeight.w300,color: Colors.white)),
                ]
            ),
          )
          ...
          child: Container(
            ...
            child: Row(
                children: <Widget>[
                  ...
                  // SizedBox(width: 2.0,),
                  Text("Facebook",style:TextStyle(fontFamily: 'Poppins',fontSize: 15,fontWeight: FontWeight.w300,color: Colors.white)),
                ]
            ),
          )
                    ...
                    Row(
                        ...
                        children:<Widget> [
                          ...
                          GestureDetector(
                            ...
                            child: Text(" SignUp",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 18,color: Colors.redAccent,fontFamily: 'Poppins'),),
                          ),
                        ])
                  ],
                ),
